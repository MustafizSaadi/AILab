...
def main(n,initArray):
    ...
    ftime = open("dls_time.txt","a")
    fnode = open("dls_node.txt","a")
    fpath = open("dls_path.txt","a")
    foutput = open("dls_output.txt","a")
    print("\nDLS")
    ...
    #print(ans)
    if ans == 2:
        print("No answer within limit " + str(limit))
    elif ans == None:
