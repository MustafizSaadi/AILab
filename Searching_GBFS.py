...
class node:
    ...
    def __init__(self, state, parent, action, path_cost):
        ...
        self.total_cost = heuristic(state, state.array.shape[0])
...
def main(n,initArray):
    ...
    ftime = open("gbfs_time.txt","a")
    fnode = open("gbfs_node.txt","a")
    fpath = open("gbfs_path.txt","a")
    foutput = open("gbfs_output.txt","a")
